...
public class MyTaxaLineTest {
	...
	public void testGetters() {
		MyTaxaLine myTaxaLine = new MyTaxaLine(SEQUENCE_REFERENCE, TAXONOMY_RANK_SPECIE, TAXONOMY_ID, SCORE, LINEAGE_SPECIES);
	...
	public void testGetDeepestTaxonomyWhenTaxonomyDeepIsGenus() throws Exception {
		MyTaxaLine myTaxaLine = new MyTaxaLine(SEQUENCE_REFERENCE, TAXONOMY_RANK_GENUS, TAXONOMY_ID, SCORE, LINEAGE_GENUS);
		String deepestTaxonomy = myTaxaLine.getDeepestTaxonomy();
