...
public class App {
	...
	private static final String AGGREGATOR_BY_FILE_NAME = "aggregatorByFileName";
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			} else if (app.equals(AGGREGATOR_BY_FILE_NAME)) {
				FileAggregator fileAggregator = new FileAggregator();
				fileAggregator.createJsonFileByConfigFileDirectoryPath(args[1], args[2]);
			...
			System.out.println("aggregatorByFileName <sample-name> <directory-path>");
